...
: ${AMENT_CURRENT_PREFIX:="/root/2ROS2workspace/freshmanproject_interface/install/freshmanproject_interface"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/freshmanproject_interface/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/freshmanproject_interface/environment/path.sh"
