...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/first_node"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/first_node/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/first_node/environment/path.sh"
