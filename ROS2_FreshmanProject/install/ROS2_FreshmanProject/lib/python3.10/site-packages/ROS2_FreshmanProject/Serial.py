...
from std_msgs.msg import Int16MultiArray, Float64MultiArray,Int64MultiArray
import serial
...
class SerialNode(Node):
    ...
    def __init__(self):
        ...
        try:
            ...
            self.get_logger().info('serial failed')
    ...
    def read_serial(self):
        ...
        if byte == b'\x55' and self.serial_port.read(1) == b'\x55':
            ...
            if byte:
                self.get_logger().info(byte.decode('utf-8'))
    ...
    def mDecode_ServoMsg(self, rawData):
        ...
        n = 4
        #self.get_logger().info('ServoData:%d,%d' % val[0],val[1])
